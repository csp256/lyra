...
// configuration step. It creates a namespace called `lyra`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", lyra::cmake::project_name, lyra::cmake::project_version) };
